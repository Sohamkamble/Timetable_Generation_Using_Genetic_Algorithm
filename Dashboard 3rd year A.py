...
timetable1 = pd.read_excel(r"C:\Users\s2kso\Desktop\Projects\TimeTable Generator\Project Timetable(Temp not for running\build1\3rd_Year_Division_1.xlsx")
timetable1
replacement_dict = {
    'SPC-Mrs. T G Deokar': 1,
    'Database-Mr. Kadam': 1, 
    'Java-Mr. Vadagave': 1, 
    'ML-Mr. Kamble': 1, 
    'EDAV-Mrs. Deokar': 1,
...
replacement_dict1 = {
    'SPC-Mrs. T G Deokar': "SPC",
    'Database-Mr. Kadam': "DB", 
    'Java-Mr. Vadagave': "JAVA", 
    'ML-Mr. Kamble': "ML", 
    'EDAV-Mrs. Deokar': "EDAV",
    'No class': " "
}
...
for row in timetable2.itertuples():
    ...
    for cell in row:
        ...
        if cell in ["SPC", "DB", "JAVA", "ML", "EDAV"]:
