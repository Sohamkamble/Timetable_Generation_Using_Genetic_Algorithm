...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\s2kso\Desktop\Projects\TimeTable Generator\Project Timetable (Latest)\build1\assets\frame3")

def open_student():
    run(["python", str(Path(r"C:\Users\s2kso\Desktop\Projects\TimeTable Generator\Project Timetable (Latest)\build1\Student.py"))])

def open_dashboard():
    subprocess.Popen(["python", r"C:\Users\s2kso\Desktop\Projects\TimeTable Generator\Project Timetable (Latest)\build1\Dashboard 2nd year A.py"]) 
...
# Load Excel file
excel_file = pd.ExcelFile(r"C:\Users\s2kso\Desktop\Projects\TimeTable Generator\Project Timetable (Latest)\build1\Students_Data.xlsx")
...
password = ""
with open(r'C:\Users\s2kso\Desktop\Projects\TimeTable Generator\Project Timetable (Latest)\build1\getpass.txt', 'r') as file:
...
dashframe = ttk.Frame(canvas)
dashframe.place(x=100, y=180, width=1240, height=1080)
...
if password // 1000 == 2 :
    ...
    if password // 100 == 1:
        ...
        place_image_on_frame(dashframe,r"C:\Users\s2kso\Desktop\Projects\TimeTable Generator\Project Timetable (Latest)\build1\2nd_Year_Division_2.png")
elif password // 1000 == 3 : 
    password = password % 1000
    if password // 100 == 1:
        place_image_on_frame(dashframe,r"C:\Users\s2kso\Desktop\Projects\TimeTable Generator\Project Timetable (Latest)\build1\3rd_Year_Division_1.png")
    else:
        place_image_on_frame(dashframe,r"C:\Users\s2kso\Desktop\Projects\TimeTable Generator\Project Timetable (Latest)\build1\3rd_Year_Division_2.png")
