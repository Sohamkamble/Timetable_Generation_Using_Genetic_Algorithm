...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\s2kso\Desktop\Projects\TimeTable Generator\Project Timetable(Temp not for running\build1\assets\frame2")



def open_gui3():
    run(["python", str(Path(r"C:\Users\s2kso\Desktop\Projects\TimeTable Generator\Project Timetable(Temp not for running\build1\gui3.py"))])
...
zoom_in_button = Button(window, text="2nd Year - A", command=lambda:display_excel_on_canvas(excel_frame,r"C:\Users\s2kso\Desktop\Projects\TimeTable Generator\Project Timetable(Temp not for running\build1\2nd_Year_Division_1.xlsx"), bg="#FF7147", fg="white")
zoom_in_button.place(x=10, y=150)

zoom_in_button1 = Button(window, text="2nd Year - B", command=lambda:display_excel_on_canvas(excel_frame1,r"C:\Users\s2kso\Desktop\Projects\TimeTable Generator\Project Timetable(Temp not for running\build1\2nd_Year_Division_2.xlsx"), bg="#FF7147", fg="white")
...
zoom_out_button = Button(window, text="Second Year", command=print("HE HE"), bg="#FF7147", fg="white")
